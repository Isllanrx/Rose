...
Portões automáticos (ADR-009): `python -m ruff check .` (regras bloqueantes do `pyproject.toml`) e `python scripts/quality_gate.py` (mypy e dívida do Ruff não podem crescer).
